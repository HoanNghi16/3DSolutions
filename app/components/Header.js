...
import { BiLogIn,BiUserPlus, BiLogOut, BiUser , BiCart, BiSolidDashboard} from 'react-icons/bi';
    ...
    return(
        <header className='mainHeader'>
            ...
            <ul className='headerMenu'>
                {isAdmin? (<li>
                    <Link className='headerMenuLink' href={'/admin'}><BiSolidDashboard className='cartIcon'></BiSolidDashboard></Link>
                </li>): null}
                {user? <li>
                    <Link className='headerMenuLink' href={'/cart'}><BiCart className='cartIcon'></BiCart><sup className='cartSummary'>{cartCount}</sup></Link>
                </li>: null}
